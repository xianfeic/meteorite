...
echo 'alias meteorite="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xianfeic/meteorite" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/meteorite'"
...
rm -rf "$HOME/.config/@meteorite"
rm -rf "$HOME/.config/@meteorite"
rm -rf "$HOME/.config/meteorite-core"
